 ...
 * F8023 电子锁下盖 标签入库
 */
public class RasF8023InitTagPlugin extends BasePlugin4Tag implements IPutStorageService {
    ...
    @Override
    public ResultBean initTag(Context context, Tag tag, String key, String EToken) {
        try {
            mContext = context;
