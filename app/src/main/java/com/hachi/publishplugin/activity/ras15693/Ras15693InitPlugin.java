 ...
 * 温控biaoq
 */
public class Ras15693InitPlugin {
    private static final String TAG = "Ras15693InitPlugin";
...
//    private static int config_intsel;
    ...
    public static ResultBean start(Context context, Tag tag, String EToken) {
        ...
        okHttp.getFromInternetById(Constant.DETAIL_URL + "?uid=" + uid + "&random=" + randomStr, EToken);
